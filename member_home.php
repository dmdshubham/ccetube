  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
          <li class="active"><a href="default.html" target="panel"><b>MEMBER PANEL</b></a></li>
          <li class="dropdown">
        ...
        <li>
            <?php
                if(!isset($_COOKIE["member_login"]))
                    ...
                    {
                        session_start();
                        echo '<a href="member_logout.php">Logout <span class="glyphicon glyphicon-log-out"></span></a>';
                    }
            ?></li>
      </ul>
    </div>
